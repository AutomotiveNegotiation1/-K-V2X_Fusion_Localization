/*
 * _coder_PositioningSystem_V4_2_api.c
 *
...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "PositioningSystem_V4_2",                             /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
void PositioningSystem_V4_2_api(const mxArray *prhs, const mxArray **plhs)
{
  ...
  *(real_T **)&PositionVector_data = emlrt_marshallIn(
  ...
  PositioningSystem_V4_2(*PositionVector_data, PositionVector_size,
                         *PositionOut);
...
void PositioningSystem_V4_2_atexit(void)
{
  ...
  PositioningSystem_V4_2_xil_terminate();
  PositioningSystem_V4_2_xil_shutdown();
...
/* End of code generation (_coder_PositioningSystem_V4_2_api.c) */
