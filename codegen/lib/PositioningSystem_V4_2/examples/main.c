...
void main_PositioningSystem_V4_2(void)
{
  double PositionVector_data[65];
  double PositionOut[10];
  int PositionVector_size[2];
  /* Initialize function 'PositioningSystem_V4_2' input arguments. */
  /* Initialize function input argument 'PositionVector'. */
  argInit_1xd65_real_T(PositionVector_data, PositionVector_size);
  /* Call the entry-point 'PositioningSystem_V4_2'. */
  PositioningSystem_V4_2(PositionVector_data, PositionVector_size, PositionOut);
}
