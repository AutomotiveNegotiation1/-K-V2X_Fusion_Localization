...
## Generated on : Tue Jul 23 17:57:07 2024
...
START_DIR                 = D:/MATLAB/Positioning_Alg_20240723
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = ../../..
COMPILER_COMMAND_FILE     = PositioningSystem_V5_1_rtw_comp.rsp
...
OBJS = PositioningSystem_V5_1_data.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj PositioningSystem_V5_1_initialize.obj PositioningSystem_V5_1_terminate.obj PositioningSystem_V5_1.obj interp1.obj mrdivide_helper.obj EKF_UWB_SLAM_4.obj mod.obj UWBPosition_V4_1.obj UWBpos_V2_3.obj inv.obj mldivide.obj abs.obj UWBMultiTagPos_V3_1.obj find.obj mean.obj EKF_UWB_SLAM_IMU_1.obj makePredA_3D_Simple.obj xzgetrf.obj exp.obj nullAssignment.obj sort.obj sortIdx.obj div.obj PositioningSystem_V5_1_emxutil.obj PositioningSystem_V5_1_rtwutil.obj
...
%.obj : $(START_DIR)/codegen/lib/PositioningSystem_V5_1/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/PositioningSystem_V5_1/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/PositioningSystem_V5_1/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/PositioningSystem_V5_1/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
mrdivide_helper.obj : $(START_DIR)/codegen/lib/PositioningSystem_V5_1/mrdivide_helper.c
	$(CC) $(CFLAGS) -o "$@" "$<"
