...
static void binary_expand_op_5(emxArray_creal_T *in1, const double in3_data[],
                           ...
                           creal_T *PosHH)
{
  ...
  if (xain_size[1] == yain_size[1]) {
    ...
    binary_expand_op_5(Xain, xain_data, xain_size, yain_data, yain_size);
    Xain_data = Xain->data;
  }
        ...
        for (nn = 0; nn < i3; nn++) {
          ...
          if (HeadingCandA_tmp <= 1.0) {
            ...
            if (b_DistMap->size[1] == TempA->size[1]) {
              ...
              binary_expand_op_1(TempA, b_DistMap);
              TempA_data = TempA->data;
            }
            k0 = TempA->size[1] << 2;
  ...
  if ((r1->size[0] == 4) && (r1->size[1] == b_DistMap->size[1])) {
    ...
    binary_expand_op_4(TempA, r1, b_DistMap);
    TempA_data = TempA->data;
  }
  emxFree_real_T(&r1);
